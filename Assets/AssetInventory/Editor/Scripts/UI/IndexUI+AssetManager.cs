...
namespace AssetInventory
{
    public partial class IndexUI
    {
        private void DrawAssetManager()
        {
            ...
            EditorGUILayout.HelpBox("If you are using Unity Asset Manager and want to index also its contents, the following packages need to be installed: Unity Cloud Assets, Unity Cloud Identity", MessageType.Error);
